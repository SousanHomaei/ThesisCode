...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRA.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRA.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRA.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRA.pkl', 'wb')
