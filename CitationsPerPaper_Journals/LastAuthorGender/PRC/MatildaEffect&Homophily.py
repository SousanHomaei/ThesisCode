...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRC.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRC.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRC.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRC.pkl', 'wb')
