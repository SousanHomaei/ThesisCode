...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRL.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLast.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLast.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLast.pkl', 'wb')
