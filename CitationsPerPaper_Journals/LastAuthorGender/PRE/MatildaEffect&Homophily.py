...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRE.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRE.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRE.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRE.pkl', 'wb')
