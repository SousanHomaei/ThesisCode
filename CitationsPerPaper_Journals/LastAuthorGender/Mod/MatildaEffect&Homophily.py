...
pkl_file = open('APSJournals/APSJournals-net/data/Last-Mod.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastMod.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastMod.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastMod.pkl', 'wb')
