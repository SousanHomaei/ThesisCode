...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRB.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRB.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRB.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRB.pkl', 'wb')
