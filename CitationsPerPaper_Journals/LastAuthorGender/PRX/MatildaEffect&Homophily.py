...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRX.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRX.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRX.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRX.pkl', 'wb')
