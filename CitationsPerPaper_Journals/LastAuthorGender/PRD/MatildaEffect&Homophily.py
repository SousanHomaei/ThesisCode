...
pkl_file = open('APSJournals/APSJournals-net/data/Last-PRD.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFLastPRD.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMLastPRD.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerLastPRD.pkl', 'wb')
