...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRA.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRA.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRA.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRA.pkl', 'wb')
