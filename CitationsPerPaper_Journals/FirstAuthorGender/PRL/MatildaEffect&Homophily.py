...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRL.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoF.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoM.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citer.pkl', 'wb')
