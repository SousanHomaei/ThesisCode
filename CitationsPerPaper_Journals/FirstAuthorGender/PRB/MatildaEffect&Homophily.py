...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRB.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRB.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRB.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRB.pkl', 'wb')
