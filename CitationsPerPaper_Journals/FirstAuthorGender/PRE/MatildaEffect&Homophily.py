...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRE.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRE.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRE.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRE.pkl', 'wb')
