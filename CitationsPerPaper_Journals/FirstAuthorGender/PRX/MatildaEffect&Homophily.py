...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRX.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRX.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRX.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRX.pkl', 'wb')
