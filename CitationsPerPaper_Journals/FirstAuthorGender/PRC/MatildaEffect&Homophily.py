...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRC.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRC.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRC.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRC.pkl', 'wb')
