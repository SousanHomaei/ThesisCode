...
pkl_file = open('APSJournals/APSJournals-net/data/First-Mod.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFMod.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMMod.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerMod.pkl', 'wb')
