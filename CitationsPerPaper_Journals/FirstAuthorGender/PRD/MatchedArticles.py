...
pkl_file = open('APSJournals/APSJournals-net/data/ToMale.pkl', 'rb')
...
for j in ToFemale:
     if j[2]<0.01 :
              if j[0].find('RevD') != -1 and j[1].find('RevD') != -1: 
...
pkl_file = open('APSJournals/APSJournals-net/data/ToFemale.pkl', 'rb')
ToFemale = pickle.load(pkl_file)
pkl_file.close()
...
output = open('APSJournals/APSJournals-net/data/First-PRD.pkl', 'wb')
