...
pkl_file = open('APSJournals/APSJournals-net/data/First-PRD.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFPRD.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMPRD.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerPRD.pkl', 'wb')
