...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRX.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRX.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRX.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRX.pkl', 'wb')
