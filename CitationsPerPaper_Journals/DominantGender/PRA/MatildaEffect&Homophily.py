...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRA.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRA.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRA.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRA.pkl', 'wb')
