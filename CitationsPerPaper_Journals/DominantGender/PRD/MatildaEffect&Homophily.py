...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRD.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRD.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRD.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRD.pkl', 'wb')
