...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRL.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDom.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDom.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDom.pkl', 'wb')
