...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-Mod.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomMod.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomMod.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomMod.pkl', 'wb')
