...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRB.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRB.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRB.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRB.pkl', 'wb')
