...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRC.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRC.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRC.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRC.pkl', 'wb')
