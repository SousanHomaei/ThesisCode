...
pkl_file = open('APSJournals/APSJournals-net/data/Dom-PRE.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFDomPRE.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMDomPRE.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerDomPRE.pkl', 'wb')
