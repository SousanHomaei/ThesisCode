...
pkl_file = open('APSJournals/APSJournals-net/data/DomAllJournals.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFAJDom.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMAJDom.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerAJDom.pkl', 'wb')
