...
pkl_file = open('APSJournals/APSJournals-net/data/FirstAllJournals.pkl', 'rb')
...
output = open('APSJournals/APSJournals-net/data/cicoFAJ.pkl', 'wb')
pickle.dump(cicoF, output)
output.close()

output = open('APSJournals/APSJournals-net/data/cicoMAJ.pkl', 'wb')
pickle.dump(cicoM, output)
output.close()

output = open('APSJournals/APSJournals-net/data/citerAJ.pkl', 'wb')
